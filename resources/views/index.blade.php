        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="h-text">
                    ...
                    @guest
                    <a href="#" target="popup" data-mfp-src="#popup-special_propos" class="btn call-btn wow fadeIn popup-with-form" data-wow-delay='.5s'>Присоединиться</a>
                    @endguest
                </div>
            </div>
        </div>
    ...
    height: 650px;"></div>
            <div class="col-lg-6 col-md-6">
                ...
                <div class="society-cols clearfix text-center">
                    <div class="society-col wow fadeInRight" data-wow-delay='.1s'>
                ...
                @guest
                <a href="#" target="popup" data-mfp-src="#popup-special_propos" class="popup-with-form btn wow fadeIn">Присоединиться к Sport Casta</a>
                @endguest
            </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12">
                <div class="btn-wrapper">
                    <a href="#" target="popup" data-mfp-src="#popup-special_propos" class="popup-with-form btn s-new_btn wow fadeIn">Подписка на обновления</a>
                </div>
            </div>
            @endguest
        </div>
