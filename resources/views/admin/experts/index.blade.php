    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <div class="col-md-4 col-xs-12">
                ...
                <a href="{{ route('admin/experts/create') }}" type="button" class="btn btn-success">Добавить</a>
        ...
        <table width="100%" class="table table-striped table-bordered table-hover">
            ...
            <tr>
                ...
                <td width="4%"><a href="javascript:" data-ng-click="sortType = 'group_name'; sortReverse = !sortReverse">
                        <span>Группа</span>
                        <i data-ng-show="(sortType == 'group_name' && sortReverse) || sortType != 'group_name'" class="fa fa-angle-down" aria-hidden="true"></i>
                        <i data-ng-show="sortType == 'group_name' && !sortReverse" class="fa fa-angle-up" aria-hidden="true"></i>
                    </a>
                </td>
            ...
            <tr data-ng-repeat="user in users | orderBy:sortType:!sortReverse | filter:searchItem">
                ...
                <td width="4%">
                    ...
                    <a type="button" class="btn btn-warning btn-xs" href="/admin/experts/@{{ user.id }}"><i class="fa fa-pencil" aria-hidden="true"></i></a>
