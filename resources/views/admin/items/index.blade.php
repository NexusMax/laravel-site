    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <div class="col-md-4 col-xs-12">
                ...
                <a href="{{ URL::route('admin/items/create') }}" type="button" class="btn btn-success">Добавить</a>
        ...
        <table width="100%" class="table table-striped table-bordered table-hover">
            ...
            <tr data-ng-repeat="item in items | orderBy:sortType:!sortReverse | filter:searchItem">
                ...
                <td width="1%">
                    ...
                    <a type="button" class="btn btn-success btn-xs" href="/@{{ item.slug }}/training/@{{ item.category_alias }}/@{{ item.alias }}" target="_blank"><i class="fa fa-eye" aria-hidden="true"></i></a>
                    <a type="button" class="btn btn-info btn-xs" href="/admin/items/@{{ item.id }}/clone"><i class="fa fa-clone" aria-hidden="true"></i></a>
                    <a type="button" class="btn btn-warning btn-xs" href="/admin/items/@{{ item.id }}"><i class="fa fa-pencil" aria-hidden="true"></i></a>
