    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <div class="col-md-4 col-xs-12">
                ...
                <a href="{{ URL::route('admin/payments/create') }}" type="button" class="btn btn-success">Добавить</a>
        ...
        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
            <thead>
            <tr>
                <td><input type="checkbox" aria-label="Checkbox for following text input" data-ng-model="selectedAll" data-ng-click="checkAll()" /></td>
                ...
                <td><a href="javascript:" data-ng-click="sortType = 'sum'; sortReverse = !sortReverse">
                        <span>Сумма</span>
                ...
                <td><a href="javascript:" data-ng-click="sortType = 'type'; sortReverse = !sortReverse">
                        <span>Тип</span>
                        <i data-ng-show="(sortType == 'type' && sortReverse) || sortType != 'type'" class="fa fa-angle-down" aria-hidden="true"></i>
                        <i data-ng-show="sortType == 'type' && !sortReverse" class="fa fa-angle-up" aria-hidden="true"></i>
                    </a>
                </td>
                <td><a href="javascript:" data-ng-click="sortType = 'count_days'; sortReverse = !sortReverse">
                        <span>Дней</span>
                        <i data-ng-show="(sortType == 'type' && sortReverse) || sortType != 'count_days'" class="fa fa-angle-down" aria-hidden="true"></i>
                        <i data-ng-show="sortType == 'type' && !sortReverse" class="fa fa-angle-up" aria-hidden="true"></i>
                    </a>
                </td>
                <td><a href="javascript:" data-ng-click="sortType = 'status'; sortReverse = !sortReverse">
                        <span>Открыт</span>
            ...
            <tr data-ng-repeat="item in items | orderBy:sortType:!sortReverse | filter:searchItem">
                ...
                <td>
                    ...
                    <a type="button" class="btn btn-warning btn-xs" href="/admin/payments/@{{ item.id }}"><i class="fa fa-pencil" aria-hidden="true"></i></a>
