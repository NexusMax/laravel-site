...
//            };
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            ...
            <a href="{{ route('admin/menu/create') }}" type="button" class="btn btn-success">Добавить</a>
                ...
                <tbody>
                    <tr data-ng-repeat="item in items | orderBy:sortType:!sortReverse | filter:searchItem">
                        ...
                        <td>
                            ...
                            <a type="button" class="btn btn-warning btn-xs" href="/admin/menu/@{{ item.id }}"><i class="fa fa-pencil" aria-hidden="true"></i></a>
