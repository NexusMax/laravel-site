            ...
            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                <thead>
                    <tr>
                        ...
                        <td><a href="javascript:" data-ng-click="sortType = 'name'; sortReverse = !sortReverse">
                        ...
                        <td><a href="javascript:" data-ng-click="sortType = 'alias'; sortReverse = !sortReverse">
                                <span>Доступ</span>
                                <i data-ng-show="(sortType == 'role_id' && sortReverse) || sortType != 'role_id'" class="fa fa-angle-down" aria-hidden="true"></i>
                                <i data-ng-show="sortType == 'role_id' && !sortReverse" class="fa fa-angle-up" aria-hidden="true"></i>
                            </a>
                        </td>
                        <td><a href="javascript:" data-ng-click="sortType = 'published'; sortReverse = !sortReverse">
                                <span>Активен</span>
                        ...
                        <td><a href="javascript:" data-ng-click="sortType = 'featured'; sortReverse = !sortReverse">
                                <span>Материал</span>
                                <i data-ng-show="(sortType == 'item_id' && sortReverse) || sortType != 'item_id'" class="fa fa-angle-down" aria-hidden="true"></i>
                                <i data-ng-show="sortType == 'item_id' && !sortReverse" class="fa fa-angle-up" aria-hidden="true"></i>
                            </a>
                        </td>
                        <td>Управление</td>
                    </tr>
                <tbody>
                    <tr data-ng-repeat="item in items | orderBy:sortType:!sortReverse | filter:searchItem">
                        ...
                        <td>
                            ...
                            <a type="button" class="btn btn-warning btn-xs" href="/admin/modules/@{{ item.id }}"><i class="fa fa-pencil" aria-hidden="true"></i></a>
