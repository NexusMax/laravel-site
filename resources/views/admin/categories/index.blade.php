            ...
            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                <thead>
                    <tr>
                        ...
                        <td><a href="javascript:" data-ng-click="sortType = 'created_at'; sortReverse = !sortReverse">
                                <span>Создано</span>
                ...
                <tbody>
                    ...
                    <td>
                        <img src="/img/icons/@{{ item.icon }}" alt="" width="20" data-ng-show="item.icon != ''" />
                        @{{ item.name }}
                    </td>
                    <td>@{{ item.alias }}</td>
                        <td>
                    ...
                    <td>
                        ...
                        <a type="button" class="btn btn-warning btn-xs" href="/admin/categories/@{{ item.id }}"><i class="fa fa-pencil" aria-hidden="true"></i></a>
