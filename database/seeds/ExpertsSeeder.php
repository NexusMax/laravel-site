    ...
    public function experts()
    {
        return [
            [
                'user_id' => '1',
                'group_id' => '1',
                'body' => '<h1 class="expertArticle-descr_name">Кристина Шевченко <span class="expertArticle-descr_job">Диетолог</span></h1>
            ...
            [
                'user_id' => '1',
                'group_id' => '2',
                'body' => ' <h1 class="expertArticle-descr_name">Лилия Савох (Ханас) <span class="expertArticle-descr_job">фитнес-эксперт</span></h1>
            ...
            [
                'user_id' => '1',
                'group_id' => '2',
                'body' => '<h3 class="expertArticle-descr_name">Александр Довгич <span class="expertArticle-descr_job">фитнес-эксперт</span></h3>
            ...
            [
                'user_id' => '1',
                'group_id' => '2',
                'body' => '<h3 class="expertArticle-descr_name">Артур Янковский <span class="expertArticle-descr_job">фитнес-эксперт</span></h3>
            ...
            [
                'user_id' => '1',
                'group_id' => '2',
                'body' => '<h3 class="expertArticle-descr_name">Екатерина Глушко <span class="expertArticle-descr_job">фитнес-эксперт проекта</span></h3>
            ...
            [
                'user_id' => '1',
                'group_id' => '2',
                'body' => '<h1 class="expertArticle-descr_name">Сергей Пуцов <span class="expertArticle-descr_job">фитнес-эксперт проекта SportCasta</span></h1>
                                <p class="expertArticle-descr_skill">Кандидат наук по физическому воспитанию и спорту;</p>
            ...
            [
                'user_id' => '1',
                'group_id' => '3',
                'body' => '<h1 class="expertArticle-descr_name">Елена Горкун <span class="expertArticle-descr_job">Психолог</span></h1>
            ...
            [
                'user_id' => '1',
                'group_id' => '4',
                'body' => ' <h1 class="expertArticle-descr_name">Юрий Бардашевский <span class="expertArticle-descr_job">Физический терапевт</span></h1>
                                <p class="expertArticle-descr_skill">Кандидат наук по физическому воспитанию и спорту;</p>
            ...
            [
                'user_id' => '1',
                'group_id' => '4',
                'body' => '<h1 class="expertArticle-descr_name">Артём Згурский <span class="expertArticle-descr_job">Физический терапевт</span></h1>
